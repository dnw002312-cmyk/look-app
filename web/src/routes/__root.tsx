...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "theme-color", content: "#0D2340" },
      { title: "LOOK — Compra. Vende. Reutiliza." },
      { name: "description", content: "LOOK es el marketplace de ropa de segunda mano donde compras, vendes y reutilizas moda desde un mismo perfil." },
      { property: "og:title", content: "LOOK — Compra. Vende. Reutiliza." },
      { property: "og:description", content: "LOOK es el marketplace de ropa de segunda mano donde compras, vendes y reutilizas moda desde un mismo perfil." },
