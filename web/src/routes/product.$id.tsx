  ...
  return (
    <AppShell>
      <div className="flex min-h-[100dvh] flex-col bg-background pb-32 md:pb-8">
        <div className="mx-auto grid w-full max-w-6xl grid-cols-1 gap-8 px-5 pb-8 pt-6 md:px-8 md:pt-8 lg:grid-cols-2">
          <div className="relative">
            <img src={product.image} className="aspect-[4/5] w-full rounded-3xl object-cover" alt={product.title} />
          ...
          <div className="md:pt-2">
            ...
            <p className="mt-5 text-sm leading-relaxed text-muted-foreground md:text-base">{product.description}</p>
            ...
            {/* Desktop buy buttons inline */}
            <div className="mt-6 hidden gap-2 md:flex">
              <Link to="/cart" className="flex-1 rounded-full border-2 border-ink py-3.5 text-center text-sm font-semibold text-ink hover:bg-muted">
                Añadir al carrito
              </Link>
