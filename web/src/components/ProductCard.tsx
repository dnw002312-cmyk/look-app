...
export function ProductCard({ product }: { product: Product }) {
  ...
  return (
    <Link
      ...
      className="group block min-w-0 rounded-2xl bg-card transition active:scale-[0.98]"
    >
      ...
      <div className="px-0.5 pt-2">
        ...
        <div className="mt-1 flex items-center justify-between gap-1.5 min-w-0">
          <span className="shrink-0 whitespace-nowrap text-sm font-bold text-ink">₡{product.price.toLocaleString()}</span>
