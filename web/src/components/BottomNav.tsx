...
type NavItem = { to: "/home" | "/search" | "/ai" | "/favorites" | "/profile"; icon: typeof Home; label: string };
...
export function BottomNav() {
  ...
  return (
    <nav className="sticky bottom-0 z-40 mt-4 border-t border-border bg-background/95 backdrop-blur-xl md:hidden">
