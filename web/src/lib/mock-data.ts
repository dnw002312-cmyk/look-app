...
export const products: Product[] = [
  // MUJER
  { id: "1", title: "Vestido midi minimalista", brand: "COS", price: 22500, size: "M", color: "Negro", condition: "Como nuevo", category: "Mujer",
  ...
  { id: "2", title: "Falda plisada midi", brand: "& Other Stories", price: 12000, size: "M", color: "Rosa", condition: "Como nuevo", category: "Mujer",
  ...
  { id: "3", title: "Blusa de seda floral", brand: "Massimo Dutti", price: 16000, size: "S", color: "Crema", condition: "Como nuevo", category: "Mujer",
  ...
  { id: "4", title: "Jeans mom fit vintage", brand: "Levi's", price: 19000, size: "38", color: "Azul", condition: "Bueno", category: "Mujer",
  ...
  // HOMBRE
  { id: "5", title: "Camisa Oxford clásica", brand: "Ralph Lauren", price: 21000, size: "L", color: "Azul", condition: "Como nuevo", category: "Hombre",
    image: img("photo-1602810318383-e386cc2a3ccf"), seller: julio,
    description: "Camisa Oxford slim fit, prácticamente sin uso." },
  { id: "6", title: "Pantalón chino beige", brand: "Uniqlo", price: 11000, size: "42", color: "Beige", condition: "Bueno", category: "Hombre",
    image: img("photo-1473966968600-fa801b869a1a"), seller: marco,
    description: "Chinos clásicos Uniqlo, tejido suave y resistente." },
  { id: "7", title: "Polo piqué slim", brand: "Lacoste", price: 14000, size: "M", color: "Verde", condition: "Como nuevo", category: "Hombre",
    image: img("photo-1586790170083-2f9ceadc732d"), seller: julio,
    description: "Polo Lacoste auténtico, color verde botella." },
  { id: "8", title: "Sudadera con capucha", brand: "Champion", price: 17500, size: "L", color: "Gris", condition: "Bueno", category: "Hombre",
    image: img("photo-1556821840-3a63f95609a7"), seller: marco,
    description: "Hoodie Champion vintage, tejido grueso reverse weave." },

  // VINTAGE
  { id: "9", title: "Chaqueta vintage oversize", brand: "Levi's", price: 19000, size: "M", color: "Beige", condition: "Como nuevo", category: "Vintage",
  ...
  { id: "10", title: "Abrigo de lana años 80", brand: "Vintage", price: 30000, size: "L", color: "Camel", condition: "Bueno", category: "Vintage",
  ...
  { id: "11", title: "Camisa hawaiana retro", brand: "Vintage", price: 9500, size: "M", color: "Multicolor", condition: "Bueno", category: "Vintage",
    image: img("photo-1562157873-818bc0726f68"), seller: marco,
    description: "Camisa hawaiana original años 70, estampado tropical." },

  // STREETWEAR
  { id: "12", title: "Camiseta gráfica Y2K", brand: "Vintage", price: 9000, size: "S", color: "Blanco", condition: "Bueno", category: "Streetwear",
  ...
  { id: "13", title: "Hoodie oversize verde", brand: "Carhartt", price: 27500, size: "L", color: "Verde", condition: "Como nuevo", category: "Streetwear",
  ...
  { id: "14", title: "Cargo pants tácticos", brand: "Dickies", price: 15000, size: "L", color: "Caqui", condition: "Bueno", category: "Streetwear",
    image: img("photo-1517438476312-10d79c077509"), seller: marco,
    description: "Pantalones cargo Dickies con múltiples bolsillos." },

  // FORMAL
  { id: "15", title: "Blazer estructurado marino", brand: "Zara", price: 16000, size: "S", color: "Marino", condition: "Como nuevo", category: "Formal",
  ...
  { id: "16", title: "Traje gris dos piezas", brand: "Hugo Boss", price: 60000, size: "L", color: "Gris", condition: "Como nuevo", category: "Formal",
  ...
  // ACCESORIOS
  { id: "17", title: "Bolso baguette piel", brand: "Mango", price: 14000, size: "Único", color: "Crema", condition: "Bueno", category: "Accesorios",
  ...
  { id: "18", title: "Cinturón cuero clásico", brand: "Massimo Dutti", price: 11000, size: "M", color: "Marrón", condition: "Como nuevo", category: "Accesorios",
    image: img("photo-1624222247344-550fb60583dc"), seller: estilo,
    description: "Cinturón de cuero genuino, hebilla metálica clásica." },
  { id: "19", title: "Gafas de sol cat-eye", brand: "Ray-Ban", price: 27500, size: "Único", color: "Negro", condition: "Como nuevo", category: "Accesorios",
    image: img("photo-1572635196237-14b3f281503f"), seller: ana,
    description: "Ray-Ban cat-eye originales, vienen con estuche." },
  { id: "20", title: "Bufanda cashmere", brand: "Acne Studios", price: 37500, size: "Único", color: "Rosa", condition: "Como nuevo", category: "Accesorios",
    image: img("photo-1601924994987-69e26d50dc26"), seller: vbag,
    description: "Bufanda Acne 100% cashmere, suavísima." },

  // ZAPATOS
  { id: "21", title: "Sneakers retro 574", brand: "New Balance", price: 32500, size: "42", color: "Gris", condition: "Bueno", category: "Zapatos",
  ...
  { id: "22", title: "Botas chelsea cuero", brand: "Dr. Martens", price: 42500, size: "40", color: "Negro", condition: "Como nuevo", category: "Zapatos",
    image: img("photo-1605812860427-4024433a70fd"), seller: kicks,
    description: "Dr. Martens chelsea negras, usadas pocas veces." },
  { id: "23", title: "Sandalias planas piel", brand: "Birkenstock", price: 20000, size: "38", color: "Marrón", condition: "Bueno", category: "Zapatos",
